...
import com.dardev.tracker_data.remote.malformedFoodResponse
import com.dardev.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search food, mal formed response, returns failure`() = runBlocking{
        mockWebServer.enqueue(
            MockResponse()
                .setBody(malformedFoodResponse)
        )
